...
export default function AboutLayout() {
    ...
    return (
        <>
            <motion.section className="flex p-10 items-center w-full min-h-screen bg-[url('/img/money.png')] bg-repeat bg- bg-center"
                initial={{ opacity: 0 }}
            ...
            <motion.section className="flex flex-col p-5"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
            >
            ...
            <motion.section className='my-10 mx-5'
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
            >
