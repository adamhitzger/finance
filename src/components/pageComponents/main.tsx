...
export default function MainLayout() {
    useGSAP(() => {
        gsap.fromTo(".container", { opacity: 0 }, { scrollTrigger: ".container", opacity: 1, duration: 3, ease: "power2.inOut" })
    });
    const words: Words[] = [
        {
            text: "Pomůžeme",
    ...
    return (
        <>
            <section className="container flex p-10 items-center w-full min-h-screen bg-[url('/img/demo-header.jpg')]">
            ...
            {/**Our service */}
            <section className="container p-10 w-full bg-skin">
